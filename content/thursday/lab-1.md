...
{{< details title="Answer 2.3" closed="true" >}}
...
{{< details title="Answer 2.4" closed="true" >}}
...
{{< details title="Answer 2.5" closed="true" >}}
...
{{< details title="Hint 3.1" closed="true" >}}
...
{{< details title="Hint 3.3a" closed="true" >}}
...
{{< details title="Hint 3.3b" closed="true" >}}
...
{{< details title="Hint 3.4" closed="true" >}}
...
{{< details title="Answer 3.7" closed="true" >}}
...
{{< details title="Hint 3.8a" closed="true" >}}
...
{{< details title="Hint 3.8b" closed="true" >}}
At this point, the partial solution to your run_star_extras.f90 file should look like this:
...
{{< details title="Answer 3.9" closed="true" >}}
...
{{< details title="Explanation 3.10" closed="true" >}}
...
{{< details title="Answer 3.11" closed="true" >}}
...
{{< details title="Answer 3.13" closed="true" >}}
...
{{< details title="Answer 4.1" closed="true" >}}
```
 HR_win_flag = .false.
...
{{< details title="Answer 4.2" closed="true" >}}
```
 ! Profile Panels 1
...
{{< details title="Hint 4.3" closed="true" >}}
```
 ! Profile Panels 2
...
{{< details title="Answer 4.4" closed="true" >}}
```
 ! Text Summary 1
...
{{< details title="Answer 4.5" closed="true" >}}
```
...
**Task 5.2**: Use this Google Colab [notebook](https://colab.research.google.com/drive/1bc6Wkne8K6Abciy7aYEnBawy9eir7XZW?usp=sharing) {{< download url="../Minilab1.ipynb" >}}(local copy){{< /download >}} to upload your <span style="color:purple">``history.data``</span> and plot (i) the evolution around the RGB bump of the location of the base of the convection zone, the peak of the burning, and the mean molecular weight discontinuity as a function of mass coordinate and radius coordinate and compare your output plot with Fig. 4 of [Hekker et al. (2020)](https://ui.adsabs.harvard.edu/abs/2020MNRAS.492.5940H/abstract).
