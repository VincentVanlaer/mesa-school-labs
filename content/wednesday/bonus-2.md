...
We are starting from a prepared work-directory which contains an adapted version of the published set of inlists connected to the paper mentioned earlier. You can download this here (fill in a link!).  
