...
!          b% s1% job% warn_run_star_extras = .false.
      ...
      integer function extras_binary_finish_step(binary_id)
         ...
         if ((b% s1% teff) .gt. 9000) then
               ...
               write(*,*) "terminating at requested effective temperature and luminosity:", b% s1% teff, log10(b% s1% l_surf), b% s1% log_surface_radius, b% s1% photosphere_r, b% s1% l_surf, b% s1% l_phot
               return
         end if 
