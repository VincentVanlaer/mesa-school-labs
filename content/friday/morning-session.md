...
**The lecture slides are [here](Goldberg_Slides_MESA_Leuven_Fri_ResTesting.pdf).**

Full solutions for mini-minilabs are available as zip files: [part 1](solutions_minimini1.zip), [part 2](solutions_minimini2.zip), and [part 3](solutions_minimini3.zip). 
...
**Solutions zip available [here](solutions_minimini1.zip)**
...
**Solutions zip available [here](solutions_minimini2.zip)**
...
**Solutions zip available [here](solutions_minimini3.zip)**
